...
class HelperPanelBot:
    ...
    def run(self) -> None:
        # The main bot owns Render's single public HTTP port.
        # The helper uses polling because it runs as a child process and has
        # a different bot token, so it does not conflict with the main bot.
